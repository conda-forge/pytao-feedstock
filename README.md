...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytao-feedstock/blob/master/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `pytao` can be installed with:

```
conda install pytao
```

It is possible to list all of the versions of `pytao` available on your platform with:
